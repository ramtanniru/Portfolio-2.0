...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      // #1E3A8A
      backgroundImage: {
        "dark-gradient": "radial-gradient(at 0% 0%,rgba(18, 18, 18, 0.4) 0px, transparent 10%), radial-gradient(at 0% 0%,rgba(30, 58, 138, 0.7) 0px, transparent 20%), radial-gradient(at 0% 0%,rgba(242, 47, 176, 0.7) 0px, transparent 30%),linear-gradient(104deg, #181c31 33.84%, #181c31 162.79%)", 
        "light-gradient": "radial-gradient(at 0% 0%,rgba(242, 47, 176, 0.7) 0px, transparent 20%),  radial-gradient(at 0% 10%, rgba(255, 197, 111, 1) 0px, transparent 25%), radial-gradient(at 100% 700px,rgba(242, 47, 176, 0.5) 0px, transparent 10%), radial-gradient(at 100% 700px, rgba(255, 197, 111, 0.4) 0px, transparent 25%),linear-gradient(0deg, rgba(255, 255, 255, 0.7)  0%, rgba(255, 255, 255, 0.7) 100%), linear-gradient(0deg, rgba(255, 221, 170, 0.7)  0%, rgba(255, 221, 170, 0.7) 100%)",
        "light-grad": "radial-gradient(at 0% 0%,rgba(242, 47, 176, 0.7) 0px, transparent 20%),  radial-gradient(at 0% 10%, rgba(255, 197, 111, 1) 0px, transparent 25%), radial-gradient(at 100% 700px,rgba(242, 47, 176, 0.5) 0px, transparent 10%), radial-gradient(at 100% 700px, rgba(255, 197, 111, 0.4) 0px, transparent 25%),linear-gradient(0deg, rgba(255, 255, 255, 0.7)  0%, rgba(255, 255, 255, 0.7) 100%)",
      },
      colors: {
